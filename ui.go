...
func createUI() error {
	...
	flex.SetBorder(true).SetTitle("ShadowFox updater 1.5.3").SetBorderPadding(1, 1, 1, 1)
	...
	if paths == nil {
		...
		text.SetBorder(true).SetTitle("ShadowFox updater 1.5.3").SetBorderPadding(1, 1, 1, 1)
